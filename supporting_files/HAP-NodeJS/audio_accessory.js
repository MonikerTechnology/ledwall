...
////////////////CHANGE THESE SETTINGS TO MATCH YOUR SETUP BEFORE RUNNING!!!!!!!!!!!!!//////////////////////////
var name = "audio";                                       //Name to Show to IOS
var UUID = "hap-nodejs:accessories:audio";     //Change the RGBLight to something unique for each light - this should be unique for each node on your system
var USERNAME = "00:00:00:00:00:A7";              //This must also be unique for each node - make sure you change it!
...
acc.username = "00:00:00:00:00:A7";
...
acc.addService(Service.Switch, name)
  ...
  .on('set', function(value, callback) {
    ...
    postData = {"type":"mode","mode":"audio"}; //set power to on
